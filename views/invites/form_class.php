...
?>
<div class="mb-4">
    <h1 class="mb-0"><?= __('Create class invite') ?></h1>
</div>
<p class="text-muted"><?= htmlspecialchars($class['course_name'] . ' – ' . $class['code'] . ' ' . $class['name']) ?></p>
<div class="card">
    <div class="card-body">
        <form method="post" action="<?= url('invites/class') ?>">
            ...
            <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="auto_approve"><?= __('Automatically approve enrollments created with this invite') ?></label>
            </div>
            <div class="mb-3">
